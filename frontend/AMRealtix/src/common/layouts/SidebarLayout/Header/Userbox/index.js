...
import { useAuth } from 'src/modules/_auth/context/auth-context'
    ...
    <>
      ...
      >
        <MenuUserBox sx={{ minWidth: 210 }} display="flex">
          <Avatar variant="rounded" alt={user.name} src={profile?.avatar} />
          <UserBoxText>
            <UserBoxLabel variant="body1">{profile?.name}</UserBoxLabel>
            <UserBoxDescription variant="body2">
              {user.jobtitle}
        ...
        <List sx={{ p: 1 }} component="nav">
          <NextLink href="/admin/account/change-password" passHref>
            <ListItem button>
